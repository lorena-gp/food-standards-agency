...
### On a website
In order to access the dashboard online, there are two options. Go to this [website](https://mybinder.org/v2/gh/lorena-gp/food-standards-agency/app/master?filepath=voila%2Frender%2FFood-and-You-survey_risks.ipynb). Or, alternatively:
